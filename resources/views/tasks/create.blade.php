            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full border rounded p-2 mt-1 mb-4 dark:bg-gray-700 dark:text-gray-200">{{ old('description') }}</textarea>
                    ...
                    @else
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                            No categories yet. <a href="{{ route('categories.create') }}" class="text-blue-600">Create one first</a> (optional).
                        </p>
                    @endif
